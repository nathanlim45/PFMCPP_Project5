...
Purpose:  This project continues developing Project3.
 ...
 If you didn't do Project3, write 3 UDTs below (where it asks for Copied UDTs) that have: 
       3 member functions,
       5 member variables, 
       constructors that initialize some of the members in the member initializer list.
              initialize the rest in-class.
       for() or while() loops that modify the member variables.
